---
title: "Data Analysis"
subtitle: "Comprehensive Data Cleaning & Exploratory Exploration of Job Market Trends"
author:
  - name: Connor Coulter
    affiliations:
      - id: bu
...
format: 
  html:
    ...
    df-print: paged
execute:
  echo: false        # HIDE CODE in the HTML
  eval: true
...
```{python}
import pandas as pd
csv_path = "data/lightcast_job_postings.csv"  # place your CSV here
...
# Numeric salary fill if present
...
```{python}
# Helpers: robust column selection
INDUSTRY_CANDIDATES = [
